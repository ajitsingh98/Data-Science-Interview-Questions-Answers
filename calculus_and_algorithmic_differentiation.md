...
### Q: 1. Write the formulae for the finite difference rule used in numerical differentiation.
...
### Q: 1. With respect to the expression graph depicted in 5.4, traverse the graph and find the function g(x) it represents.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `1. With respect to the expression graph depicted in 5.4, traverse the graph and find the function g(x) it represents.`.
...
### Q: 1. The chain rule is key concept in differentiation. Define it.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `1. The chain rule is key concept in differentiation. Define it.`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `Find the Taylor series expansion for:`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `Find the Taylor series expansion for: (Part 2)`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `Find the Taylor series expansion centered at $x = −3$ for:`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `At $x = 1$, compute the first $7$ terms of the Taylor series expansion of:`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `Find the following limits:`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
### Q: 1. True or false: When applying a partial derivative, there are two variables considered constants - the dependent and independent variable.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `1. True or false: When applying a partial derivative, there are two variables considered constants - the dependent and independent variable.`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `How can we use the Hessian (second derivative matrix) to test for critical points?`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `The gradient of a two-dimensional function is given by`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `Find the partial derivatives of:`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `Find the partial derivatives of: (Part 2)`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `Consider $f(x) = \frac{x^2 + 1}{(x+2)^2}$`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `Consider $f(x) = 2x^3 − x$`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `Consider the function`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `The gradient descent algorithm can be utilized for the minimization of convex functions.`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
### Q: 1. Is the data linearly separable?
...
- **Direct Solution**: Analytical solution and mathematical formulation for `1. Is the data linearly separable?`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `Given a logistic discriminant classifier:`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `Most ML algorithms we use nowadays use first-order derivatives (gradients) to construct the next training iteration.`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `1. During the training of an ANN, a sigmoid layer applies the sigmoid function to every element in the forward pass, while in the backward pass the chain rule is being utilized as part of the backpropagation algorithm. With respect to the backpropagation algorithm, given a sigmoid $σ(x) = \frac{e^x}{1+e^x}$ activation function, and a J as the cost function, annotate each part of equation (5.21):`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
### Q: 1. **True or false**: InAutograd if any input tensor of an operation has *requires_grad=True*, the computation will be tracked. After computing the backward pass, a gradient w.r.t. this tensor is accumulated into *.grad* attribute
...
- **Direct Solution**: Analytical solution and mathematical formulation for `1. **True or false**: InAutograd if any input tensor of an operation has *requires_grad=True*, the computation will be tracked. After computing the backward pass, a gradient w.r.t. this tensor is accumulated into *.grad* attribute`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `Your friend, a veteran of the DL community wants to use logistic regression and implement custom activation functions using Autograd. Logistic regression is used when the variable y that we want to predict can only take on discrete values (i.e. classification). Considering a binary classification problem (y = 0 or y = 1), the hypothesis function could be defined so that it is bounded between [0, 1] in which we use some form of logistic function, such as the sigmoid function. Other, more efficient functions exist such as the ReLU (Rectified Linear Unit) which we discussed later. Note: The weights in (5.8) are only meant for illustration purposes and are not part of the solution.`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `For real values, $−1 < x < 1$ the hyperbolic tangent function is defined as:`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
### Q: 1. Explain how AD uses floating point numerical rather than symbolic expressions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `1. Explain how AD uses floating point numerical rather than symbolic expressions.`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `1. Expand the following function using DN:`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `With respect to the expression graph depicted in 5.10:`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `When differentiating a function using forward-mode AD, the computation of such an expression can be computed from its corresponding directed a-cyclical graph by propagating the numerical values.`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `Answer the following given that a computational graph of a function has N inputs and`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `1. Given the function:`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
### Q: Answer the following questions: (Part 2)
...
- **Direct Solution**: Analytical solution and mathematical formulation for `Answer the following questions: (Part 2)`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `You will most likely not be given such a long programming task during a face-to-face interview. Nevertheless, an extensive home programming assignment is typically given at many of the start-ups I am familiar with. You should allocate around approximately four to six hours to completely answer all questions in this problem.`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
