...
# Forward pass of 2-layer neural network
...
$$output = \begin{cases} 0, & \text{if } \sum_j(w_jx_j + b) \leq 0, \\ 1, & \text{if } \sum_j(w_jx_j + b) > 0 \end{cases}$$
...
- **Direct Solution**: Analytical solution and mathematical formulation for `Complete the sentence: To solve this mathematical equation, we have to apply $[...]$?`.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `What does the following equation stands for?`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `The following questions refer to the MLP depicted in (8.15).`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `Activation functions.`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `Why shouldn’t we have two consecutive linear layers in a neural network?`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `Can a neural network with only RELU (non-linearity) act as a linear classifier?`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `Your co-worker, an postgraduate student at M.I.T, suggests using the following activa-`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `You are provided with the following MLP as depicted in 8.16.`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `If someone is quoted saying: MLP networks are universal function approximators. What does he mean?`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `**True or False**: the output of a perceptron is 0 or 1.`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `**True or False:** A multi-layer perceptron falls under the category of supervised machine learning.`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `**True or False:** The accuracy of a perceptron is calculated as the number of correctly`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `Repeat the above assuming now that the bias term B1 was amended and equals −0.25.`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `Define what is the perceptron learning rule.`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `What was the most crucial difference between Rosenblatt’s original algorithm and Hinton’s fundamental papers of 1986: <a href="">Learning representations by back-propagating errors</a> and 2012:`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `The AND logic gate is defined by the following table:`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `Design the smallest neural network that can function as an XOR gate.`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `The Hyperbolic tangent nonlinearity, or the tanh function (Fig. 8.23), is a widely used neuron activation function in artificial neural networks:`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `The code snippet in 8.24 makes use of the tanh function.`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `Your friend, a veteran of the DL community claims that MLPs based on tanh activation function, have a symmetry around 0 and consequently cannot be saturated. Saturation, so he claims is a phenomenon typical of the top hidden layers in sigmoid based MLPs. Is he right or wrong?`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `If we initialize the weights of a tanh based NN, which of the following approaches will lead to the vanishing gradients problem?`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `You friend, who is experimenting with the tanh activation function designed a small CNN with only one hidden layer and a linear output (8.25):`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `You are experimenting with the ReLU activation function, and you design a small CNN (8.26) which accepts an RGB image as an input. Each CNN kernel is denoted by $w$.`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `Name the following activation function where $a ∈ (0, 1)$:`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `In many interviews, you will be given a paper that you have never encountered before, and be required to read and subsequently discuss it. Please read <a href="https://arxiv.org/pdf/1710.05941.pdf">Searching for Activation Functions</a> before attempting the questions in this question.`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `Referring the code snippet in Fig. (8.31), answer the following questions regarding the VGG11 architecture [25]:`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `Still referring the code snippet in Fig. (8.31), and specifically to line 7, the code is amended so that the line is replaced by the line: `vgg_layers=vgg11.features[:3]`.`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `Table (8.1) presents an incomplete listing of the of the VGG11 architecture [25]. As depicted, for each layer the number of filters (i. e., neurons with unique set of parameters) are presented.`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `A Dropout layer [26] (Fig. 8.32) is commonly used to regularize a neural network model by randomly equating several outputs (the crossed-out hidden node H) to 0.`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `A co-worker claims he discovered an equivalence theorem where, two consecutive Dropout layers [26] can be replaced and represented by a single Dropout layer 8.34.`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `If he uses the following filter for the convolutional operation, what would be the resulting`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `What would be the resulting tensor after the application of the ReLU layer (8.37)?`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `What would be the resulting tensor after the application of the MaxPool layer (8.78)?`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `The following input 8.38 is subjected to a MaxPool2D(2,2) operation having 2 × 2 max-pooling filter with a stride of 2 and no padding at all.`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `Weight normalization separates a weight vector’s norm from its gradient. How would it help with training?`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `In python, the probability density function for a normal distribution is given by 8.40:`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `Your friend, a novice data scientist, uses an RGB image (8.41) which he then subjects to BN as part of training a CNN.`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `**True or false**: An activation function applied after a Dropout, is equivalent to an activation function applied before a dropout.`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `Which of the following core building blocks may be used to construct CNNs? Choose all the options that apply:`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `You are designing a CNN which has a single BN layer. Which of the following core CNN designs are valid? Choose all the options that apply:`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `The following operator is known as the Hadamard product:`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `Visualized in (8.43) from a high-level view, is an MLP which implements a well-known idiom in DL.`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `Answer the following questions regarding residual networks.`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `Your friend was thinking about ResNet blocks, and tried to visualize them in (8.45).`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `A certain training pipeline for the classification of large images (1024 x 1024) uses the following Hyperparameters (8.46):`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `A junior data scientist in your team who is interested in Hyperparameter tuning, wrote the following code (8.5) for spiting his corpus into two distinct sets and fitting an LR model:`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `In the context of Hyperparameter optimization, explain the difference between grid search and random search.`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `Non-invasive methods that forecast the existence of lung nodules (8.47), is a precursor to lung cancer. Yet, in spite of acquisition standardization attempts, the manual detection of lung nodules still remains predisposed to inter mechanical and observer variability. What is more, it is a highly laborious task.`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `Answer the following questions regarding the validation curve visualized in (8.48):`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `Learning rate.`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `It’s a common practice for the learning rate to be reduced throughout the training.`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `Refer to the validation log-loss curve visualized in (8.49) and answer the following questions:`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `Why don’t we just initialize all weights in a neural network to zero?`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `You finished training a face recognition algorithm, which uses a feature vector of 128`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `Complete the sentence: If the training loss is insignificant while the test loss is significantly higher, the network has almost certainly learned features which are not present in an `[...]` set. This phenomena is referred to as `[...]``.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `What does the term stochastic in SGD actually mean? Does it use any random number generator?`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `Stochasticity.`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `Gradient descent vs SGD vs mini-batch SGD.`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `Write the vanilla gradient update.`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `Explain why in SGD, the number of epochs required to surpass a certain loss threshold increases as the batch size decreases?`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `It’s a common practice to train deep learning models using epochs: we sample batches from data without replacement. Why would we use epochs instead of just sampling data with replacement?`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `Batch size.`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `Vanishing and exploding gradients.`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `How does momentum work? Explain the role of exponential decay in the gradient descent update rule?`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `Why is Adagrad sometimes favored in problems with sparse gradients?`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `Adam vs. SGD.`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `With model parallelism, you might update your model weights using the gradients from each machine asynchronously or synchronously. What are the pros and cons of asynchronous SGD vs. synchronous SGD?`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `In your training loop, you are using SGD and a logistic activation function which is`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `Which of the following statements holds true?`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `Answer the following questions regarding norms.`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `Why is squared L2 norm sometimes preferred to L2 norm for regularizing neural networks?`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `You are provided with a pure Python code implementation of the Manhattan distance`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `Your friend is training a logistic regression model for a binary classification problem using the L2 loss for optimization. Explain to him why this is a bad choice and which loss he should be using instead.`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `What’s the motivation for skip connection in neural works?`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `Your model’ weights fluctuate a lot during training. How does that affect your model’s performance? What to do about it?`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `Some models use weight decay: after each gradient update, the weights are multiplied by a factor slightly less than 1. What is this useful for?`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `Dead neuron.`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `Pruning.`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `1. What is batch normalization?`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `Compare batch norm and layer norm.`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `Under what conditions would it be possible to recover training data from the weight checkpoints?`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `Why do we try to reduce the size of a big trained model through techniques such as knowledge distillation instead of just training a small model from the beginning?`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `You’re building a neural network and you want to use both numerical and textual features. How would you process those different features?`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `What criteria would you use for early stopping?`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
...
- **Direct Solution**: Analytical solution and mathematical formulation for `When building a neural network, should you overfit or underfit it first?`.
- **Key Takeaway**: Standard interview answer evaluating key properties, edge cases, and statistical assumptions.
